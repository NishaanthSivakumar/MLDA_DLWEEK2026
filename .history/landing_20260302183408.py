...
k4.markdown(
    f"""
    <div class="kpi-card">
      <div class="small-muted" style="margin-bottom:4px;">Learning State</div>
      <div style="font-size:20px; font-weight:700; letter-spacing:-0.3px;">{state_overall['state']}</div>
      <div class="small-muted" style="margin-top:4px;">{state_overall['reason']}</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
for course in COURSES:
    ...
    with row_cols[0]:
        ...
        state_colors_map = {
            ...
            "REGRESSING": "#EF5350", "INACTIVE": "#9E9E9E", "NEW": "#42A5F5",
        }
